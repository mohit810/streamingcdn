...
func CreateWebRTCConnection(streamKey, offerStr string) (answer webrtc.SessionDescription, err error) {
	...
	go func(peerConnection *webrtc.PeerConnection) {
		...
		streamURL := fmt.Sprintf("rtmp://live.twitch.tv/app/%s", streamKey)
